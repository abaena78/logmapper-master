# -*- coding: utf-8 -*-
"""
Created on Sat Jan 20 16:34:26 2018
...
def buildFuzzySystem(showDescription = False):
    ...
    **Returns**:
    ...
    var_in1['average'] = fuzz.trapmf(var_in1.universe, [in1_max*0.2, in1_max*0.4, in1_max*0.8, in1_max*0.9])
