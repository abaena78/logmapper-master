# -*- coding: utf-8 -*-
"""
Created on Sat Jan 20 22:42:51 2018
...
def buildFuzzySystem(showDescription = False):
    ...
    **Returns**:
    ...
    var_in1['high'] = fuzz.smf(var_in1.universe, 0.2*in1_max, 0.8*in1_max)
...
if __name__ == '__main__':
    ...
    if not showDescription:
        fuzzysim.input['disk_io_rate_w'] = 15.0
        fuzzysim.compute()
