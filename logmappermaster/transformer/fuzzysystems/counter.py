# -*- coding: utf-8 -*-
"""
Created on Sat Jan 20 21:28:41 2018
...
#    var_in1['average'] = fuzz.trapmf(var_in1.universe, [0, 0.3*in1_max, 0.7*in1_max, in1_max])
#    var_in1['high'] = fuzz.trimf(var_in1.universe, [0.7*in1_max, in1_max, in1_max])
